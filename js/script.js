...
function updateForm(){
  ...
  document.getElementById("formTitle").innerText =
    isSignup ? "Create Your Fashion Account" : "Welcome Back";

  document.getElementById("formSubtitle").innerText =
    isSignup 
    ? "Sign up to discover trendy outfits and exclusive deals"
    : "Login to explore latest fashion trends and manage your orders";
